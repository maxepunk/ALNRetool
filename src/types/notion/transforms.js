...
exports.getRollupArray = getRollupArray;
exports.getRollupStrings = getRollupStrings;
exports.getDate = getDate;
exports.getFormula = getFormula;
exports.getUrl = getUrl;
exports.parseSFPatterns = parseSFPatterns;
exports.transformCharacter = transformCharacter;
exports.transformElement = transformElement;
exports.transformPuzzle = transformPuzzle;
exports.transformTimelineEvent = transformTimelineEvent;
...
function getRollupArray(prop) {
    if (!prop || prop.type !== 'rollup')
        return [];
...
function getRollupStrings(prop) {
...
function parseSFPatterns(text) {
    ...
    if (memoryMatch?.[1]) {
        ...
        if (typeMatch) {
            patterns.memoryType = typeMatch[1];
        }
    }
...
function transformCharacter(page) {
    const props = page.properties;
    return {
        id: page.id,
        name: getTitle(props['Name']),
        type: (getSelect(props['Type']) || 'NPC'),
        tier: (getSelect(props['Tier']) || 'Tertiary'),
...
function transformElement(page) {
    const props = page.properties;
    ...
    return {
        ...
        basicType: (getSelect(props['Basic Type']) || 'Prop'),
        ...
        status: (getStatus(props['Status']) || 'Idea/Placeholder'),
        firstAvailable: getSelect(props['First Available']),
        requiredForPuzzleIds: getRelationIds(props['Required For']),
        rewardedByPuzzleIds: getRelationIds(props['Rewarded By']),
...
function transformTimelineEvent(page) {
    ...
    return {
        ...
        memTypes: getRollupStrings(props['mem type']),
